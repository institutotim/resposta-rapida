...
class Message(models.Model):
    ...
    connection = models.ForeignKey(Connection, null=True, verbose_name=u"Origem")
    direction = models.CharField(max_length=1, choices=DIRECTION_CHOICES, verbose_name=u"Direção")
