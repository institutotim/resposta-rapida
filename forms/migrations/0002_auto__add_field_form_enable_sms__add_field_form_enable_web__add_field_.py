...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form.enable_sms'
        db.add_column('forms_form', 'enable_sms',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Form.enable_web'
        db.add_column('forms_form', 'enable_web',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Form.enable_wap'
        db.add_column('forms_form', 'enable_wap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Form.enable_java'
        db.add_column('forms_form', 'enable_java',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form.enable_sms'
        db.delete_column('forms_form', 'enable_sms')

        # Deleting field 'Form.enable_web'
        db.delete_column('forms_form', 'enable_web')

        # Deleting field 'Form.enable_wap'
        db.delete_column('forms_form', 'enable_wap')

        # Deleting field 'Form.enable_java'
        db.delete_column('forms_form', 'enable_java')
